  ...
  return (
    <section className="relative overflow-hidden pt-28 pb-16 md:pt-36 md:pb-24">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col items-center px-4 text-center md:px-8">
        ...
        {/* Main Headline */}
        <h1 className="max-w-4xl text-3xl sm:text-5xl md:text-6xl font-black leading-[1.08] tracking-tight text-white">
        ...
        <p className="mt-5 max-w-2xl text-sm sm:text-base md:text-lg text-slate-300 leading-relaxed">
          Evitá sobreprecios. Calculá en segundos el costo real de <strong className="text-white font-semibold">mano de obra por m²</strong> y recibí la lista exacta de pintura, rodillos y enduido para pedir con descuento en <span className="text-[#ffe600] font-bold">Mercado Libre</span>.
        </p>
        ...
        <div className="mt-8 flex w-full max-w-md flex-col gap-3 sm:flex-row sm:justify-center">
          <button
            ...
            className="flex h-13 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[#ff6a00] to-[#ea580c] px-7 text-sm font-extrabold text-white shadow-[0_0_30px_-5px_rgba(255,106,0,0.5)] transition-all hover:scale-[1.03] hover:shadow-[0_0_35px_-3px_rgba(255,106,0,0.7)] active:scale-[0.98]"
          >
          ...
          <a
            href="#transparencia"
            className="flex h-13 items-center justify-center gap-2 rounded-2xl border border-white/15 bg-white/[0.04] px-6 text-sm font-bold text-slate-200 backdrop-blur-md transition-all hover:border-[#ff6a00]/40 hover:bg-[#ff6a00]/10 hover:text-white"
          >
        ...
        {/* Stats Grid estilo motoplan18 */}
        <div className="mt-14 grid w-full max-w-3xl grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-2xl border border-white/10 bg-[#111726]/70 backdrop-blur-md px-4 py-4 text-center transition-all hover:border-[#ff6a00]/30 hover:scale-[1.02]">
            <p className="text-2xl font-black text-[#ff6a00] md:text-3xl">+18.500</p>
            <p className="mt-1 text-xs text-slate-400">Presupuestos calculados</p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#111726]/70 backdrop-blur-md px-4 py-4 text-center transition-all hover:border-[#ff6a00]/30 hover:scale-[1.02]">
            <p className="text-2xl font-black text-[#ff6a00] md:text-3xl">100%</p>
            <p className="mt-1 text-xs text-slate-400">Precios reales de mercado</p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#111726]/70 backdrop-blur-md px-4 py-4 text-center transition-all hover:border-[#ff6a00]/30 hover:scale-[1.02]">
            <p className="text-2xl font-black text-[#ff6a00] md:text-3xl">4.9 ★</p>
            <p className="mt-1 text-xs text-slate-400">Precisión en materiales</p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#111726]/70 backdrop-blur-md px-4 py-4 text-center transition-all hover:border-[#ff6a00]/30 hover:scale-[1.02]">
            <p className="text-2xl font-black text-[#ff6a00] md:text-3xl">0 Spam</p>
            <p className="mt-1 text-xs text-slate-400">100% Libre y gratuito</p>
          </div>
        </div>

        {/* Banner de Afiliación Mercado Libre integrado */}
        <div className="mt-8 flex items-center justify-center gap-2 rounded-2xl border border-yellow-400/20 bg-yellow-400/5 px-4 py-2.5 text-xs text-slate-300">
          <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#ffe600] text-slate-900 font-extrabold text-[10px]">
            ML
          </span>
          <span>
            Los materiales calculados se conectan con <strong className="text-[#ffe600]">Mercado Libre</strong> para compra inmediata con cuotas y envío rápido a tu domicilio.
          </span>
        </div>
